...
import '../../view_model/card_controller/remove_card.dart';
import '../home_screen.dart';
import '../notification/notification_screen.dart';
import '../stylish_tab_bar_view.dart';
import 'my_card.dart';

class ManageCardRed extends StatefulWidget {
  final String party;
  ...
  const ManageCardRed(this.party, this.description, this.frontImage,
      this.backImage, this.cardId, this.cardStatus,
      {super.key});

  @override
  State<ManageCardRed> createState() => _ManageCardRedState();
}

class _ManageCardRedState extends State<ManageCardRed> {
  RemoveCardController removeCardController = Get.put(RemoveCardController());
  ...
  Future removeCardApi(String cardId) async {
    ...
    try {
      var response = await http
          .post(Uri.parse("${MasterUrl.apiLink}remove_card"), headers: {
...
class StarController extends GetxController {
  RxBool starBool = false.obs;

  setStar(bool value) {
    starBool.value = !value;
  }
}
